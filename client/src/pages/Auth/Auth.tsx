      ...
      >
        <Box width="100%" maxWidth={450} p={5} alignSelf="center">
          <Grid container direction={'column'} justifyContent="center" alignItems="center">
            ...
            {type === 'login' ? (
              <Grid item xs component={LoginForm} handleSubmit={handleLogin} />
            ) : (
              <Grid item xs component={SignUpForm} handleSubmit={handleSignup} />
            )}
            <Grid
              item
              xs
              ...
              asideText={type === 'login' ? "Don't have an account?" : 'Already a member?'}
